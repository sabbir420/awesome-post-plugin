...
* 
*/
class CustomTaxonomyController extends PathController
{
	public $settings;
	...
	public function setSettings()
	{
		$args = array(
			array(
				'option_group' => 'oddly_plugin_tax_settings',
				'option_name' => 'oddly_plugin_tax',
	...
	public function registerCustomTaxonomy()
	{
		foreach ($this->taxonomies as $taxonomy) {
			register_taxonomy( $taxonomy['rewrite']['slug'], 'publication' , $taxonomy );
		}
	}
}