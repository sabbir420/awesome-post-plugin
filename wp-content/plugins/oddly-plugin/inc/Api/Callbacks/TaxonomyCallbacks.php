...
class TaxonomyCallbacks
{
	...
	{
		$output = get_option('oddly_plugin_tax');
	...
	/*public function radioButtonField( $args )
	{
		...
		echo '<div class="' . $classes . '"><input type="radio" id="' . $name . '" name="' . $option_name . '[' . $name . ']" value="'. $name .'" class=""><label for="' . $name . '"><div></div></label></div>';
	}*/
}